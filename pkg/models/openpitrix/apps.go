...
type PatchAppVersionRequest struct {
	// app description
	Description *string `json:"description,omitempty"`
...
type AppVersionActionRequest struct {
...
func DescribeApp(id string) (*opmodels.OpenpitrixApp, error) {
	...
	var app *opmodels.OpenpitrixApp
...
func CreateApp(request *opmodels.OpenpitrixCreateAppRequest) (*opmodels.OpenpitrixCreateAppResponse, error) {
	op, err := cs.ClientSets().OpenPitrix()
	if err != nil {
		klog.Error(err)
		return nil, err
	...
	return &opmodels.OpenpitrixCreateAppResponse{
		AppID: resp.GetAppId().GetValue(),
	}, nil
}

func PatchApp(appId string, request *PatchAppRequest) error {
	client, err := cs.ClientSets().OpenPitrix()
...
func CreateAppVersion(request *opmodels.OpenpitrixCreateAppVersionRequest) (*opmodels.OpenpitrixCreateAppVersionResponse, error) {
	op, err := cs.ClientSets().OpenPitrix()
	if err != nil {
		klog.Error(err)
		return nil, err
	}
	r := &pb.CreateAppVersionRequest{
	...
	if request.Package != nil {
		r.Package = &wrappers.BytesValue{Value: request.Package}
	}

	resp, err := op.App().CreateAppVersion(openpitrix.SystemContext(), r)
	if err != nil {
		klog.Error(err)
		return nil, err
	}
	return &opmodels.OpenpitrixCreateAppVersionResponse{
		VersionID: resp.GetVersionId().GetValue(),
	}, nil
}

func ValidatePackage(request *opmodels.OpenpitrixValidatePackageRequest) (*opmodels.OpenpitrixValidatePackageResponse, error) {
	client, err := cs.ClientSets().OpenPitrix()
	...
	result := &opmodels.OpenpitrixValidatePackageResponse{}
...
func PatchAppVersion(id string, request *PatchAppVersionRequest) error {
	op, err := cs.ClientSets().OpenPitrix()
	if err != nil {
		klog.Error(err)
		return err
...
func DescribeAppVersion(id string) (*opmodels.OpenpitrixAppVersion, error) {
	op, err := cs.ClientSets().OpenPitrix()
	if err != nil {
		klog.Error(err)
		return nil, err
	...
	var app *opmodels.OpenpitrixAppVersion
...
func GetAppVersionPackage(appId, versionId string) (*opmodels.OpenpitrixGetAppVersionPackageResponse, error) {
	op, err := cs.ClientSets().OpenPitrix()
	if err != nil {
		klog.Error(err)
		return nil, err
	...
	app := &opmodels.OpenpitrixGetAppVersionPackageResponse{
		AppID:     appId,
		VersionID: versionId,
	}
...
func DoAppVersionAction(versionId string, request *AppVersionActionRequest) error {
	op, err := cs.ClientSets().OpenPitrix()
	...
	case "cancel":
		_, err = op.App().CancelAppVersion(openpitrix.SystemContext(), &pb.CancelAppVersionRequest{
			VersionId: &wrappers.StringValue{Value: versionId},
		})
	case "pass":
		_, err = op.App().AdminPassAppVersion(openpitrix.SystemContext(), &pb.PassAppVersionRequest{
			VersionId: &wrappers.StringValue{Value: versionId},
		})
	case "recover":
	...
	case "reject":
		_, err = op.App().AdminRejectAppVersion(openpitrix.SystemContext(), &pb.RejectAppVersionRequest{
			VersionId: &wrappers.StringValue{Value: versionId},
		})

	case "submit":
		_, err = op.App().SubmitAppVersion(openpitrix.SystemContext(), &pb.SubmitAppVersionRequest{
			VersionId: &wrappers.StringValue{Value: versionId},
		})
	case "suspend":
	...
	case "release":
		_, err = op.App().ReleaseAppVersion(openpitrix.SystemContext(), &pb.ReleaseAppVersionRequest{
			VersionId: &wrappers.StringValue{Value: versionId},
		})
	default:
...
func GetAppVersionFiles(versionId string, request *GetAppVersionFilesRequest) (*opmodels.OpenpitrixGetAppVersionPackageFilesResponse, error) {
	op, err := cs.ClientSets().OpenPitrix()
	if err != nil {
		klog.Error(err)
		return nil, err
	...
	app := &opmodels.OpenpitrixGetAppVersionPackageFilesResponse{
		VersionID: versionId,
	}

	if resp.Files != nil {
		app.Files = make(map[string]strfmt.Base64)
