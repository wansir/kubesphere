...
func CreateCategory(request *opmodels.OpenpitrixCreateCategoryRequest) (*opmodels.OpenpitrixCreateCategoryResponse, error) {
	...
	return &opmodels.OpenpitrixCreateCategoryResponse{
...
func PatchCategory(id string, request *PatchCategoryRequest) error {
	op, err := cs.ClientSets().OpenPitrix()
	if err != nil {
		klog.Error(err)
		return err
...
func DescribeCategory(id string) (*opmodels.OpenpitrixCategory, error) {
	op, err := cs.ClientSets().OpenPitrix()
	if err != nil {
		klog.Error(err)
		return nil, err
	...
	var category *opmodels.OpenpitrixCategory
