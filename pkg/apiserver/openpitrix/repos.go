...
func CreateRepo(req *restful.Request, resp *restful.Response) {
	createRepoRequest := &opmodels.OpenpitrixCreateRepoRequest{}
...
func PatchRepo(req *restful.Request, resp *restful.Response) {
	var updateRepoRequest openpitrix.PatchRepoRequest
	repoId := req.PathParameter("repo")
...
func ValidateRepo(req *restful.Request, resp *restful.Response) {
	validateRepoRequest := &openpitrix.ValidateRepoRequest{}
	err := req.ReadEntity(validateRepoRequest)
