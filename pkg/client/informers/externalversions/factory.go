...
import (
	...
	component "kubesphere.io/kubesphere/pkg/client/informers/externalversions/component"
...
func (f *sharedInformerFactory) Component() component.Interface {
	return component.New(f, f.namespace, f.tweakListOptions)
}
