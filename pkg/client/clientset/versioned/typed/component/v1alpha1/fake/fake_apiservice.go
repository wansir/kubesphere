...
type FakeAPIServices struct {
	Fake *FakeComponentV1alpha1
}

var apiservicesResource = schema.GroupVersionResource{Group: "component.kubesphere.io", Version: "v1alpha1", Resource: "apiservices"}

var apiservicesKind = schema.GroupVersionKind{Group: "component.kubesphere.io", Version: "v1alpha1", Kind: "APIService"}

// Get takes name of the aPIService, and returns the corresponding aPIService object, and an error if there is any.
func (c *FakeAPIServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.APIService, err error) {
	obj, err := c.Fake.
...
func (c *FakeAPIServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.APIServiceList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.APIServiceList{ListMeta: obj.(*v1alpha1.APIServiceList).ListMeta}
...
func (c *FakeAPIServices) Create(ctx context.Context, aPIService *v1alpha1.APIService, opts v1.CreateOptions) (result *v1alpha1.APIService, err error) {
	obj, err := c.Fake.
...
func (c *FakeAPIServices) Update(ctx context.Context, aPIService *v1alpha1.APIService, opts v1.UpdateOptions) (result *v1alpha1.APIService, err error) {
	obj, err := c.Fake.
...
func (c *FakeAPIServices) UpdateStatus(ctx context.Context, aPIService *v1alpha1.APIService, opts v1.UpdateOptions) (*v1alpha1.APIService, error) {
	obj, err := c.Fake.
...
func (c *FakeAPIServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.APIService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(apiservicesResource, name, pt, data, subresources...), &v1alpha1.APIService{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.APIService), err
