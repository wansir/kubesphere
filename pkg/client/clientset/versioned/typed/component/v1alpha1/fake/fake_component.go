...
var componentsResource = schema.GroupVersionResource{Group: "component.kubesphere.io", Version: "v1alpha1", Resource: "components"}

var componentsKind = schema.GroupVersionKind{Group: "component.kubesphere.io", Version: "v1alpha1", Kind: "Component"}
...
func (c *FakeComponents) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Component, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(componentsResource, name), &v1alpha1.Component{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeComponents) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComponentList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(componentsResource, componentsKind, opts), &v1alpha1.ComponentList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeComponents) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(componentsResource, opts))
}
...
func (c *FakeComponents) Create(ctx context.Context, component *v1alpha1.Component, opts v1.CreateOptions) (result *v1alpha1.Component, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(componentsResource, component), &v1alpha1.Component{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Component), err
...
func (c *FakeComponents) Update(ctx context.Context, component *v1alpha1.Component, opts v1.UpdateOptions) (result *v1alpha1.Component, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(componentsResource, component), &v1alpha1.Component{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Component), err
...
func (c *FakeComponents) UpdateStatus(ctx context.Context, component *v1alpha1.Component, opts v1.UpdateOptions) (*v1alpha1.Component, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(componentsResource, "status", component), &v1alpha1.Component{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Component), err
...
func (c *FakeComponents) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(componentsResource, name), &v1alpha1.Component{})
	return err
}

// DeleteCollection deletes a collection of objects.
func (c *FakeComponents) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(componentsResource, listOpts)
...
func (c *FakeComponents) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Component, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(componentsResource, name, pt, data, subresources...), &v1alpha1.Component{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Component), err
